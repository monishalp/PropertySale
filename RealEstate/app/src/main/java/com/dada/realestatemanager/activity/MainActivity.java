...
import com.dada.realestatemanager.fragment.AddPropertyFragment;
import com.dada.realestatemanager.fragment.EditPropertyFragment;
import com.dada.realestatemanager.fragment.ViewPropertyFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.view_added_property) {
            ...
            editor.apply();
            startActivity(new Intent(MainActivity.this, SelectBuyerSellerActivity.class));
        }
