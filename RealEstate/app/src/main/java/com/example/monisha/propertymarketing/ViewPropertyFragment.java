...
public class ViewPropertyFragment extends Fragment {
    ...
    public void onViewCreated(View view, final Bundle savedInstanceState) {
        ...
        JsonArrayRequest jsonArray = new JsonArrayRequest(Constants.MYPROPERTY_URL + getActivity().getIntent().getStringExtra("userid"),
//        JsonArrayRequest jsonArray = new JsonArrayRequest(Constant.PROPERTY_URL,
    ...
    private void deleteProperty(int id) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Constants.DELETE_PROPERTY_URL + String.valueOf(id), new Response.Listener<String>() {
            @Override
